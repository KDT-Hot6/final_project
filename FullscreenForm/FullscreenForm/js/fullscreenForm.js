...
;( function( window ) {
	...
	FForm.prototype._addControls = function() {
		...
		this.ctrlContinue = createElement( 'button', { cName : 'fs-continue', inner : '검색하기', appendTo : this.ctrls } );
	...
	window.onscroll = function() {onStickyFunction()};

	// Get the header
	var header = document.getElementById("fs-form-wrap");

	// Get the offset position of the navbar
	var sticky = header.offsetTop;

	// Add the sticky class to the header when you reach its scroll position. Remove "sticky" when you leave the scroll position
	function onStickyFunction() {
